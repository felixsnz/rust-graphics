...
use crate::render::{block::*, texture::*};
    ...
    pub fn get_texture_coordinates(&self, texture_corner: [u32; 2], face_direction: FaceDirection) -> [f32; 2] {
        match self {
            BlockType::GRASS => match face_direction {
                ...
                FaceDirection::RIGHT => atlas_pos_to_coordinates([3.0, 0.0], texture_corner),
                FaceDirection::LEFT => atlas_pos_to_coordinates([3.0, 0.0], texture_corner),
                FaceDirection::FRONT => atlas_pos_to_coordinates([3.0, 0.0], texture_corner),
                FaceDirection::BACK => atlas_pos_to_coordinates([3.0, 0.0], texture_corner),
            },
